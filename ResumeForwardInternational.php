...
<title>Job Portal/ResumeForwardInternational</title>
...
<!-- Main Middle--><table style="width:1048px; height:auto; border:solid 1px #E6E6E6; margin:auto;">
  <tr><td>
	...
	<tr><td>
	<table style="width:255px;margin-left:0px; margin-right:0px; margin-bottom:90px;margin-top:0px;">
	<tr>
...
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:255px;border: 1px #CCCCCC solid; margin-left:0px;">
	<li class="topfirst"><a href="ResumeForwardIndia.php" style="height:40px;line-height:40px; width:255px; border-radius:15px 15px 0px 0px; border:#000000 0px solid;">     <div style="padding-left:0px;"><b> &nbsp;Resume Forward ELE</b></div></a></li>

	 <li style="height:2px;width:265px;"></li>

	<li class="toplast"><a href="ResumeForwardInternational.php" style="height:40px;background-color:#000000;color:#FFFFFF;line-height:40px;width:255px;"><div style="padding-left:0px;"><b> &nbsp;Resume Forward International</b></div></a></li>

 <li style="height:2px;width:265px;"></li>

    <li class="topmenu"><a href="ResumeForwardBoth.php" style="height:40px;line-height:40px;margin-left:0px; width:255px;"><div style="padding-left:0px;"><b> &nbsp;Resume Forward Both</b></div></a></li>
		...
		<!-- CLOSE TABLE 1--></table>
				...
				<!--TABLE 2--><table style="width:467px; background-color:#FFFFFF; font-size:14px; height:auto;border-radius: 4px; box-shadow: 0px 0px 0px #CCCCCC; float:left;  border: 1px #CCCCCC solid;">
	<tr><td>
	<table style="width:467px;margin-left:0px; margin-right:0px; margin-bottom:0px;margin-top:0px;">
	<tr>
	<td style="height:auto; border: 0px #CCCCCC solid; ">
...
$server=mysql_query("select * from static where page='ResumeForwardInternational'");
