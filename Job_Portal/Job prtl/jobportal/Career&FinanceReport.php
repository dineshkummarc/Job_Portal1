...
<title>Job Portal/Career&FinanceReport </title>
...
<!--slider--><div style="1050px; height:350px; border:solid 0px #999900;">
<img src="images/resume-11101202.jpg"  width="1048" height="348"/>
</div><!--slider close-->
...
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:255px;border: 1px #CCCCCC solid; margin-left:0px;">
	<li class="topfirst"><a href="Career&FinanceReport.php" style="height:40px;line-height:40px; width:255px; border-radius:15px 15px 0px 0px;  background-color:#000000; color:#FFFFFF; border:#000000 0px solid;"><div style="padding-left:0px;"><b> &nbsp;Career & Finance Report</b></div></a></li>

	<li style="height:2px;width:265px;"></li>

	<li class="toplast"><a href="JobChangePlanning.php" style="height:40px;line-height:40px;
	 width:255px;"><div style="padding-left:0px;"><b> &nbsp;Job Change Planning</b></div></a></li>
