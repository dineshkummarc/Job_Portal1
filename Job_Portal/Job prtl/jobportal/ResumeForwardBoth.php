...
<title> Job Portal/ResumeForwardBoth</title>
...
<!-- Main Middle--><table style="width:1048px; height:auto; border:solid 1px #E6E6E6; margin:auto;">
  <tr><td>
		...
		<tr>
		<td>
		<!--TABLE 1--><table style="width:255px; margin-top:0px;  background-color:#FFFFFF; font-size:14px; height:auto;border-radius: 4px; box-shadow: 0px 0px 4px #CCCCCC; float:left;  border: 0px #CCCCCC solid;">
	<tr><td>
...
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:255px;border: 1px #CCCCCC solid; margin-left:0px;">
 ...
 <li style="height:2px;width:265px;"></li>
	...
	<li class="toplast"><a href="ResumeForwardInternational.php" style="height:40px;line-height:40px; width:255px;"><div style="padding-left:0px;"><b> &nbsp;Resume Forward International</b></div></a></li>

 <li style="height:2px;width:265px;"></li>

    <li class="topmenu"><a href="ResumeForwardBoth.php" style="height:40px; background-color:#000000; color:#FFFFFF;line-height:40px;margin-left:0px; width:255px;"><div style="padding-left:0px;"><b> &nbsp;Resume Forward Both</b></div></a></li>
