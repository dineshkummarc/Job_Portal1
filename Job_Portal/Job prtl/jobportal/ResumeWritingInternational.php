...
<title> Job Portal/ResumeWritingELE</title>
...
$(document).ready(function(){
    $('#state').change(function()
    {
    		$("#city").slideDown("slow");
    	   var id=$(this).val();
    	   $('#city').load('rw_i_nat.php',{id:id},function(){});
    });
});
</script>
<script type="text/javascript">
...
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:255px;border: 1px #CCCCCC solid; margin-left:0px;">
	...
	<li class="toplast"><a href="ResumeWritingInternational.php" style="height:40px;background-color:#000000; color:#FFFFFF;  line-height:40px; width:255px;"><div style="padding-left:0px;"><b> &nbsp;Resume Writing International</b></div></a></li>
