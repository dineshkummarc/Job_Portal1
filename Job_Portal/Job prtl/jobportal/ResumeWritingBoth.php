...
<title>Job Portal/ResumeWritingBoth</title>
...
$(document).ready(function(){
    $('#state').change(function()
    {
    		$("#city").slideDown("slow");
    	   var id=$(this).val();
    	   $('#city').load('rw_both.php',{id:id},function(){});
    });
});
</script>
<script type="text/javascript">
...
<ul id="css3menu11" class="topmenu" style="margin-top:18px;;border-radius: 14px;width:255px;border: 1px #CCCCCC solid; margin-left:0px;">
		<li class="topfirst"><a href="ResumeWritingIndia.php" style="height:40px;line-height:40px; width:255px; border-radius:15px 15px 0px 0px;  border:#000000 0px solid;"><div style="padding-left:0px;"><b> &nbsp;Resume Writing ELE</b></div></a></li>
 ...
 <li style="height:2px;width:265px;"></li>
    ...
    <li class="topmenu"><a href="ResumeWritingBoth.php" style="height:40px; background-color:#000000; color:#FFFFFF;line-height:40px;margin-left:0px; width:254px;"><div style="padding-left:0px;"><b> &nbsp;Resume Writing Both</b></div></a></li>
...
<li class="toplast"><a href="CoverLetterIndia.php" style="height:40px;line-height:40px; width:255px;"><div style="padding-left:0px;"><b> &nbsp;Cover Letter India</b></div></a></li>
 ...
 <li style="height:2px;width:265px;"></li>
	...
	<td style="height:auto; border: 0px #CCCCCC solid; ">
	 ...
	 <?php
			include('dbconnection.php');
$server=mysql_query("select * from static where page='ResumeWritingBoth'");
