...
<b>Disclaimer </b><br />
 Job Portal is a resume service provider. Though we help in circulating your resume to relevant avenues in the market for suitable jobs and many customers have benefited from over service, we do not guarantee jobs or interview calls by purchasing any product from us. </div>
</div>
</div>
...
<div style="width:240px;background-color:#000;  height:170px; float:left;color:#FFFFFF; border:solid 1px #000;">
 <table height="165" style="width:251px; height:auto;color:#FFFFFF;font-family:Arial, Helvetica, sans-serif; font-size:14px;">
	  ...
	  <tr><td><img src="images/visa.jpg" width="88" /></td>
	   ...
	   <tr><td>&nbsp;</td><td></td></tr>
	  <tr><td colspan="2">We also accept Debit Cards and Net Banking. See all supported Payment Options.</td></tr>
