...
<title>Resume2WORK/Education+EmployeeVarification</title>
...
<li style="height:2px;width:265px;"></li>
    ...
    <li class="topmenu"><a href="Employee&EducationVerification.php" style="height:40px;background-color:#000000; color:#FFFFFF;line-height:40px;margin-top:0px;margin-left:0px; width:265px;"><div style="padding-left:0px;"><b> &nbsp;Education+Employee Verification</b></div></a></li>
...
$server=mysql_query("select * from static where page='BothVarification'");
	...
	<!--**********************************************-->
			<form method='post' action='data.php' name='frm1'>
					<?php include('dbconnection.php');
						$ser="Employee And Education Verification";
